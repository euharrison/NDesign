package seisd.form
{
	...
	public class FormContact extends Form 
	{
		...
		override public function errorValidation(e:FormularioEvent):void 
		{
			if (status) status.text = 'Por favor, preencha os campos corretamente';
		}
		
		override public function sendInit(e:FormularioEvent):void 
		{
			if (status) status.text = 'Enviando e-mail...';
		}
		
		override public function sendError(e:FormularioEvent):void 
		{
			if (status) status.text = 'Erro no servidor. Por favor, tente novamente.';
		}
		
		override public function sendSuccess(e:FormularioEvent):void 
		{
