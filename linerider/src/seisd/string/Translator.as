package seisd.string
{
	...
	public class Translator 
	{
		 ...
		 * @param	container Container de TextFields
		...
		{
			return _dictionary.child(id).attribute(_language) || id;
		}
		...
		{
			return Boolean(String(_dictionary.child(id).attribute(_language)));
		}
