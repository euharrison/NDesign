package seisd.sound
{
	...
	public class Playlist extends EventDispatcher 
	{
		...
		{
			if (shuffleTracks) ArrayUtils.mix(navMP3.itemList);
			
			navMP3.load();
			navMP3.activateFirst();
		}
		 ...
		 * MP3Loader(navMP3.currentItem)
		 */
		public function get currentSoundLoader():MP3Loader
		{
			return MP3Loader(navMP3.currentItem);
		}
